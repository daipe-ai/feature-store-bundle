...
from featurestorebundle.metadata.schema import get_metadata_pk_columns, get_metadata_columns


class MetadataTableDataHandler:
    def __init__(self, logger: Logger, spark: SparkSession):
        self.__logger = logger
        self.__spark = spark

    def merge(self, full_table_name: str, metadata_df: DataFrame):
