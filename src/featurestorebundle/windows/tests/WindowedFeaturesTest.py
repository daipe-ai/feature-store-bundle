...
import time
from featurestorebundle.windows.windowed_features import _is_past_time_window, _is_future_time_window
...
class WindowedFeaturesTest(unittest.TestCase):
    ...
    def test_future_time_windows(self):
        ...
        self.assertFalse(_is_future_time_window(run_date, arg_date, "30d"))
        self.assertTrue(_is_future_time_window(run_date, arg_date, "60d"))
        self.assertTrue(_is_future_time_window(run_date, arg_date, "90d"))

    def test_wrong_order_future_time_windows(self):
        run_date = get_unix_timestamp("2021-11-18")
        arg_date = get_unix_timestamp("2021-10-17")

        self.assertFalse(_is_future_time_window(run_date, arg_date, "30d"))
        self.assertFalse(_is_future_time_window(run_date, arg_date, "60d"))
        self.assertFalse(_is_future_time_window(run_date, arg_date, "90d"))
