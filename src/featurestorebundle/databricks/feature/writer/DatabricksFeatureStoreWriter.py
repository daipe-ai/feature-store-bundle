...
from featurestorebundle.databricks.feature.writer.DatabricksFeatureStorePreparer import DatabricksFeatureStorePreparer
...
class DatabricksFeatureStoreWriter(FeaturesWriterInterface):
    def __init__(
        ...
        features_table_preparer: DatabricksFeatureStorePreparer,
