...
class FeaturePatternTest(unittest.TestCase):
    def test_simple(self):
        template = FeatureTemplate("test_feature", "test description", 0, "int")
    ...
    def test_placeholders(self):
        template = FeatureTemplate("test_{arg1}_{arg2}_something", "test description", 0, "int")
        pattern = FeaturePattern(template)
    ...
    def test_appedix(self):
        template = FeatureTemplate("test_something", "test description", 0, "int")
        pattern = FeaturePattern(template)
